...
#define ARE_EQUAL(first, second) _Generic((first),                                                            \
    char*: strcmp((const char*)(uintptr_t)(first), (const char*)(uintptr_t)(second)) == 0,                    \
    const char*: strcmp((const char*)(uintptr_t)(first), (const char*)(uintptr_t)(second)) == 0,              \
...
static inline size_t generate_random_number_##type(Bag_##type* bag){                                          \
    if (bag -> size == 0) {                                                                                   \
        return 0;                                                                                             \
                                                                                                              ...
                                                                                                              \
    size_t number;                                                                                            \
    if (getrandom(&number, sizeof(size_t), GRND_NONBLOCK) != (ssize_t)sizeof(size_t)) {                       \
        number = (size_t)rand();                                                                              \
    }                                                                                                         \
